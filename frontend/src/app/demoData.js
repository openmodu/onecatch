...
export const demoWorkspaces = [
  { id: "onecatch-demo", name: "onecatch", path: "~/Code/openmodu/onecatch", defaultSandbox: "workspace-write", lastOpenedAt: demoNow },
];
...
export const demoTasks = [
  ...
  { id: "task_queue_demo", worktree: { contextId: "worktree:onecatch-demo:git-ui", path: "~/Code/openmodu/onecatch-git-ui", root: "~/Code/openmodu/onecatch-git-ui", branch: "onecatch/git-ui", managed: true }, workspaceId: "onecatch-demo", title: "补齐任务页 Git 工作流", prompt: "接通状态、Diff、提交信息生成和推送，并验证异常提示。", workflowId: "single_agent", harness: "codex", status: "queued", executionMode: "queued", queue: { state: "waiting", enqueuedAt: demoNow, authorized: true }, attachments: [], createdAt: demoNow, updatedAt: demoNow },
];
...
export const demoRun = {
  ...
  runtimeEvents: [
    ...
    { stepRunId: "step_1", seq: 2, kind: "message", text: "我先检查中断和恢复的现有实现，再补齐缺失的状态反馈。", at: demoNow },
    { stepRunId: "step_1", seq: 3, kind: "tool_use", text: "rg -n \"interrupt|pause\" internal desktop", at: demoNow },
    { stepRunId: "step_1", seq: 4, kind: "tool_result", text: "internal/usecase/workflows/usecase.go:212\nfrontend/src/app/App.jsx:118", at: demoNow },
    { stepRunId: "step_1", seq: 5, kind: "file_change", text: "internal/usecase/workflows/usecase.go", at: demoNow },
    { stepRunId: "step_1", seq: 6, kind: "context_compaction", text: '{"beforeTokens":180000,"afterTokens":32000,"contextWindow":200000}', at: demoNow },
    { stepRunId: "step_1", seq: 7, kind: "message", text: "## 实现完成\n\n- 已拆分调度层\n- 已补充中断恢复测试\n\n```go\ngo test ./internal/usecase/workflows\n```", at: demoNow },
    { stepRunId: "step_2", seq: 1, kind: "message", text: "我会先运行相关测试，再给出审查结论。", at: demoNow },
    { stepRunId: "step_2", seq: 2, kind: "tool_use", text: "go test ./...", at: demoNow },
    { stepRunId: "step_2", seq: 3, kind: "tool_result", text: "ok  github.com/openmodu/onecatch/internal/usecase/workflows", at: demoNow },
    { stepRunId: "step_2", seq: 4, kind: "message", text: "### 审查结论\n\n| 项目 | 状态 |\n| --- | --- |\n| 核心流程 | ✅ |\n| 中断反馈 | 待完善 |", at: demoNow },
    { stepRunId: "step_2", seq: 5, kind: "result", text: '{"signal":"changes_requested","content":"建议在暂停区域明确展示恢复后的当前步骤。"}', at: demoNow },
  ],
  active: false,
};
