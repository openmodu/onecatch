...
if (declaredRuntime !== bundledRuntime || lockedRuntime !== bundledRuntime) {
  console.error([
    ...
    "Pin @wailsio/runtime to the bundled version and regenerate package-lock.json.",
  ].join("\n"));
  process.exit(1);
}

console.log(`Wails dependencies aligned: Go ${wails.Version}, JS ${bundledRuntime}`);
