...
func (a *App) GitStatus(ctx context.Context, workspaceID string) (domainworkspaces.GitSnapshot, error) {
...
func (a *App) GitDiff(ctx context.Context, workspaceID string, staged bool) (string, error) {
	workspace, err := a.GetWorkspace(ctx, strings.TrimSpace(workspaceID))
	if err != nil {
		return "", err
	}
...
func (a *App) GitStageAll(ctx context.Context, workspaceID string) error {
	workspace, err := a.GetWorkspace(ctx, strings.TrimSpace(workspaceID))
	if err != nil {
		return err
	}
...
func (a *App) GitCommitAndPush(ctx context.Context, input GitCommitInput) (GitCommitResult, error) {
