...
func (a *App) InitializeSettings(ctx context.Context) error {
...
func (a *App) SetSettingsReload(reload func(domainsettings.Settings) error) {
	a.settingsReload = reload
}

func (a *App) GetSettings(ctx context.Context) (domainsettings.Settings, error) {
...
func (a *App) UpdateRuntimeSettings(ctx context.Context, value map[string]domainsettings.RuntimeSettings, expected int64) (domainsettings.Settings, error) {
...
func (a *App) UpdateExecutionSettings(ctx context.Context, value domainsettings.ExecutionSettings, expected int64) (domainsettings.Settings, error) {
	return a.updateSettings(ctx, expected, func(current *domainsettings.Settings) { current.Execution = value })
}
func (a *App) UpdateSecuritySettings(ctx context.Context, value domainsettings.SecuritySettings, expected int64) (domainsettings.Settings, error) {
	return a.updateSettings(ctx, expected, func(current *domainsettings.Settings) { current.Security = value })
}
func (a *App) UpdateStorageSettings(ctx context.Context, value domainsettings.StorageSettings, expected int64) (domainsettings.Settings, error) {
	return a.updateSettings(ctx, expected, func(current *domainsettings.Settings) { current.Storage = value })
}
func (a *App) UpdateExperimentalSettings(ctx context.Context, value domainsettings.ExperimentalSettings, expected int64) (domainsettings.Settings, error) {
	return a.updateSettings(ctx, expected, func(current *domainsettings.Settings) { current.Experimental = value })
}

func (a *App) ResetSettingsSection(ctx context.Context, section string, expected int64) (domainsettings.Settings, error) {
...
func (a *App) CheckRuntimeDraft(input RuntimeDraftInput) (RuntimeInfo, error) {
...
func (a *App) applySettings(value domainsettings.Settings) error {
...
func (a *App) PreviewRun(ctx context.Context, taskID string) (RunStartPreview, error) {
...
func (a *App) validateTaskSecurity(ctx context.Context, taskID, confirmationToken string) error {
	task, err := a.store.Repos.Tasks.GetTask(ctx, taskID)
	if err != nil {
		return mapError(err)
	}
...
func (a *App) resolveRunSettings(ctx context.Context, taskID string) (domainworkflows.Definition, workflowuc.RunResolution, error) {
	task, err := a.store.Repos.Tasks.GetTask(ctx, taskID)
	if err != nil {
